...
//check apakah tombol login ingin ditekan
...
<head>
    ...
    <!-- fav icon -->
    <link rel="icon" href="assets/img/unsil.png">
...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="" method="POST">
            <img class="mb-4 d-block mx-auto " src="assets/img/unsil.png" alt="" width="75" height="75">
            ...
            <div class="form-floating"> <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="Password...." required> <label for="floatingPassword">Password</label>
            </div>
            </label> </div> <button class="btn btn-success w-100 py-2" type="submit" name="login">Login</button>
            <p class="mt-5 mb-3 text-body-secondary text-center">Copyright &copy; Alvaro <?= date('Y') ?></p>
        </form>
    </main>
